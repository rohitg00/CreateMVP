...
import { ArrowRight, Code, FileText, Zap, Layers, Sparkles, CheckCircle, ChevronRight, Download, Plus } from "lucide-react";
...
const aiTools = [
  ...
  { name: "Cursor", icon: "https://cursor.sh/apple-touch-icon.png" },
...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "Free users can generate up to 5 implementation plans per month. Pro subscribers have unlimited access to all features including unlimited plan generation."
  },
  {
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Give Your AI Models a Clear Blueprint</h2>
              <p className="text-slate-300 mb-8">
                You can build anything with AI. From web apps to mobile apps, and even extensions and plugins. Our platform helps you create detailed documentation that serves as a clear blueprint for your AI tools.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start">
                    <CheckCircle className="h-6 w-6 text-indigo-400 mr-2 flex-shrink-0 mt-0.5" />
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-1 rounded-2xl border border-slate-700/30"
            >
              <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-xl p-8">
                <div className="aspect-video bg-slate-800 rounded-lg overflow-hidden">
                  <a href="https://screen.studio/share/xBBnViyc" target="_blank" rel="noopener noreferrer" className="block w-full h-full">
                    <div className="relative w-full h-full">
                      <div className="w-full h-full bg-gradient-to-br from-indigo-900/90 to-purple-900/90 flex items-center justify-center">
                        <div className="text-center">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-12 h-12 mx-auto mb-2 text-indigo-400 opacity-80">
                            <polygon points="5 3 19 12 5 21 5 3" />
                          </svg>
                          <p className="text-indigo-200 font-medium text-lg">AI MVP Guide Demo</p>
                        </div>
                      </div>
                      <div className="absolute inset-0 flex items-center justify-center bg-black/50 hover:bg-black/30 transition-colors">
                        ...
                        <p className="absolute bottom-4 text-white font-medium">Demo Video</p>
                      </div>
                    </div>
                  </a>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://github.com/amm0nite/ai-mvp-guide" target="_blank" rel="noreferrer" className="group">
                ...
                <a href="/contribute" className="group">
                  <div className="flex items-center gap-2 px-5 py-2.5 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-200">
              ...
              <div className="flex items-center gap-3 mt-10">
                <div className="flex -space-x-3">
                  ...
                  <img 
                    ...
                    className="w-8 h-8 rounded-full border-2 border-slate-900" 
                  />
                  <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-slate-900 bg-slate-800 text-xs text-slate-400">
                    +25
                  </div>
                </div>
                <span className="text-slate-400 text-sm">Join our growing community of contributors</span>
              </div>
            </div>
                  ...
                  <div className="border border-slate-700/30 rounded-lg overflow-hidden">
                    ...
                    <div className="p-4 bg-slate-950/50 text-sm text-slate-300 font-mono overflow-hidden">
                      ...
                      <div className="flex mb-4">
                        ...
                        <span className="text-green-400">](https://img.shields.io/github/stars/amm0nite/ai-mvp-guide)</span>
                      </div>
